...
global.owner = process.env.OWNER_NUMBER  || '2348130505901' ;  // ADD YOUR NUMBER WITHOUT +
...
global.sudo  =  process.env.SUDO || "2348105370225,2348026390054,2348121059814" ;          // DON'T REMOVE
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '07_05_2024_SIGMA_MD_zGJXaTF5_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'BBOTᴅ',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `BLAQTVɪ`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'BBOTʀ',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "BBOTʀ" ,          // ADD YOUR STICKER PACKNAME
  ...
  antibadwords_values: process.env.ANTI_BAD_WORDS || 'Fuck,porn,sex,xxx,fucker,asshole,fuck you,fuck off,werey,ode,mad,stupid,foolish,scammer',   // IT WILL TAKES ACTIONS WHO SENDS THESE BAD WORDS
